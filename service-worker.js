const CACHE='recife-condo-atlas-phase1-v1';
const ASSETS=['./','./index.html','./styles.css','./app.js','./manifest.webmanifest','./icons/icon-180.png','./icons/icon-192.png','./icons/icon-512.png','./data/buildings.json','./data/listings.json','./data/summary.json'];
